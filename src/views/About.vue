...
const data = {
  ...
  softSkills: [
    ...
    { title: 'Live Casino Game', icon: 'nodejs', start: '2023/06/01', company: '中佑資訊視訊組' },
    { title: 'Casino Game', icon: 'pixijs', start: '2022/06/01', company: '中佑資訊機率組' },
    { title: '麻將胡了', icon: 'cocos2d', start: '2021/06/01', company: '中佑資訊' },
    { title: '遊戲活動抽獎', icon: 'vue', start: '2020/06/01', company: '中佑資訊' },
    { title: '圖片編輯器', icon: 'vite', start: '2018/06/01', company: '中佑資訊' },
  ],
  social: [],
}
