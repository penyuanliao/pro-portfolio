<template xmlns="http://www.w3.org/1999/html">
  <div class="relative text-slate-900 transition-colors duration-300 dark:text-white">
    <!-- PixiJS 容器 -->
    <div ref="pixiContainer" class="fixed inset-0 z-0"></div>
    
    <!-- 各個區塊組件化 -->
    <section class="hero-section relative z-10 flex min-h-screen flex-col items-center justify-center text-center">
       <!-- ... Hero 內容 ... -->
       <div class="reveal-content">
        ...
        <div ref="cta" class="opacity-0">
          <router-link to="/about" class="rounded-full bg-blue-600 px-8 py-3 font-semibold transition-transform hover:scale-105 active:scale-95">
            Explore More
          </router-link>
        </div>
      </div>
    ...
    <section class="relative z-10 flex h-screen items-center justify-center">
      <div class="scroll-final text-center">
        ...
        <p class="mt-6 text-xl text-slate-400">Currently available for freelance and full-time positions.</p>
      </div>
    </section>
  </div>
</template>
